---
title: SessionStartHookOutput
description: "Represents the complete output for a SessionStart hook.             Combines base output fields with SessionStart-specific output."
icon: file-brackets-curly
keywords: ['SessionStartHookOutput', 'CloudNimble.ClaudeEssentials.Hooks.Outputs.SessionStartHookOutput', 'CloudNimble.ClaudeEssentials.Hooks.Outputs', 'class', 'CloudNimble.ClaudeEssentials.Hooks.Outputs.HookOutputBase']
---
...
```csharp
CloudNimble.ClaudeEssentials.Hooks.Outputs.SessionStartHookOutput
```
...
```csharp
public CloudNimble.ClaudeEssentials.Hooks.Outputs.SessionStartSpecificOutput HookSpecificOutput { get; set; }
```
