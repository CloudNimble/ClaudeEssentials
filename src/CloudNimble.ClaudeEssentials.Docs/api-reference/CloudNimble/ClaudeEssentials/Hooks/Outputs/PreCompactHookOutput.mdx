---
title: PreCompactHookOutput
description: "Represents the output for a PreCompact hook.             The PreCompact hook typically only uses base output fields."
icon: file-brackets-curly
keywords: ['PreCompactHookOutput', 'CloudNimble.ClaudeEssentials.Hooks.Outputs.PreCompactHookOutput', 'CloudNimble.ClaudeEssentials.Hooks.Outputs', 'class', 'CloudNimble.ClaudeEssentials.Hooks.Outputs.HookOutputBase']
---
...
```csharp
CloudNimble.ClaudeEssentials.Hooks.Outputs.PreCompactHookOutput
```

## Summary

Represents the output for a PreCompact hook.
            The PreCompact hook typically only uses base output fields.
