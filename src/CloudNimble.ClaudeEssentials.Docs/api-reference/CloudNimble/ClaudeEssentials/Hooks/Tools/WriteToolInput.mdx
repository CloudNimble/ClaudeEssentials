...
keywords: ['WriteToolInput', 'CloudNimble.ClaudeEssentials.Hooks.Tools.WriteToolInput', 'CloudNimble.ClaudeEssentials.Hooks.Tools', 'class', 'System.Object']
---
...
```csharp
CloudNimble.ClaudeEssentials.Hooks.Tools.WriteToolInput
```
