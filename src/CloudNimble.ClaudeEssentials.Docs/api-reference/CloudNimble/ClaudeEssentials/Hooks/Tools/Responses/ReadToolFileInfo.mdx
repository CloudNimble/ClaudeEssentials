...
## Remarks
            ...
            When using the `offset` and `limit` parameters in [ReadToolInput](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Tools/Inputs/ReadToolInput),
            the [ReadToolFileInfo.StartLine](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Tools/Responses/ReadToolFileInfo#startline) and [ReadToolFileInfo.NumLines](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Tools/Responses/ReadToolFileInfo#numlines) properties will reflect the
            subset of lines that were actually returned, while [ReadToolFileInfo.TotalLines](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Tools/Responses/ReadToolFileInfo#totallines) always
...
This value reflects the actual number of lines returned, which may be less than
            [ReadToolFileInfo.TotalLines](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Tools/Responses/ReadToolFileInfo#totallines) if the `offset` and `limit` parameters were used
            in the original [ReadToolInput](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Tools/Inputs/ReadToolInput), or if the file was truncated due to size.
...
Line numbers in Claude Code are 1-based, meaning the first line of a file is line 1.
            If an `offset` was specified in the [ReadToolInput](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Tools/Inputs/ReadToolInput), this value
...
This represents the complete line count of the file, regardless of how many lines
            ...
            partially read (when [ReadToolFileInfo.NumLines](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Tools/Responses/ReadToolFileInfo#numlines) is less than [ReadToolFileInfo.TotalLines](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Tools/Responses/ReadToolFileInfo#totallines)).
