...
## Remarks
            ...
            tool invocations using the [WebSearchResultContainer.ToolUseId](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Tools/Responses/WebSearchResultContainer#tooluseid). Each container holds multiple
