...
## Remarks
            ...
            [GrepPostToolUsePayload](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Tools/GrepPostToolUsePayload) when the
            `tool_name` is "Grep".
            ...
            The response structure varies based on the [GrepToolInput.OutputMode](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Tools/Inputs/GrepToolInput#outputmode):
