...
## Remarks
            ...
            to it. This response is received in the [TaskPostToolUsePayload](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Tools/TaskPostToolUsePayload)
...
- `claude-code-guide` - Documentation and guidance queries
            ...
            Agents can be resumed using the [TaskToolResponse.AgentId](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Tools/Responses/TaskToolResponse#agentid) returned in the response,
