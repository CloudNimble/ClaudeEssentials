...
keywords: ['BashToolInput', 'CloudNimble.ClaudeEssentials.Hooks.Tools.BashToolInput', 'CloudNimble.ClaudeEssentials.Hooks.Tools', 'class', 'System.Object']
---
...
```csharp
CloudNimble.ClaudeEssentials.Hooks.Tools.BashToolInput
```
