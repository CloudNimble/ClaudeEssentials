...
keywords: ['GlobToolInput', 'CloudNimble.ClaudeEssentials.Hooks.Tools.GlobToolInput', 'CloudNimble.ClaudeEssentials.Hooks.Tools', 'class', 'System.Object']
---
...
```csharp
CloudNimble.ClaudeEssentials.Hooks.Tools.GlobToolInput
```
