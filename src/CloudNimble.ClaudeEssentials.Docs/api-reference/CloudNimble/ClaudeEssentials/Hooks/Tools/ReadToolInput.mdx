...
keywords: ['ReadToolInput', 'CloudNimble.ClaudeEssentials.Hooks.Tools.ReadToolInput', 'CloudNimble.ClaudeEssentials.Hooks.Tools', 'class', 'System.Object']
---
...
```csharp
CloudNimble.ClaudeEssentials.Hooks.Tools.ReadToolInput
```
