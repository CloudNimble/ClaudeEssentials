...
keywords: ['WebFetchToolInput', 'CloudNimble.ClaudeEssentials.Hooks.Tools.WebFetchToolInput', 'CloudNimble.ClaudeEssentials.Hooks.Tools', 'class', 'System.Object']
---
...
```csharp
CloudNimble.ClaudeEssentials.Hooks.Tools.WebFetchToolInput
```
