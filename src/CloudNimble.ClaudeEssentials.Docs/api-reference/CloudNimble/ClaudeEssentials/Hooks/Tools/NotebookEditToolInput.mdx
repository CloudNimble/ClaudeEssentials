...
keywords: ['NotebookEditToolInput', 'CloudNimble.ClaudeEssentials.Hooks.Tools.NotebookEditToolInput', 'CloudNimble.ClaudeEssentials.Hooks.Tools', 'class', 'System.Object']
---
...
```csharp
CloudNimble.ClaudeEssentials.Hooks.Tools.NotebookEditToolInput
```
