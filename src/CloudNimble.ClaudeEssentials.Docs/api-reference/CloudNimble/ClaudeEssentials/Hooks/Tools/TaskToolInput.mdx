...
keywords: ['TaskToolInput', 'CloudNimble.ClaudeEssentials.Hooks.Tools.TaskToolInput', 'CloudNimble.ClaudeEssentials.Hooks.Tools', 'class', 'System.Object']
---
...
```csharp
CloudNimble.ClaudeEssentials.Hooks.Tools.TaskToolInput
```
