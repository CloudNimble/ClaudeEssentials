...
keywords: ['GrepToolInput', 'CloudNimble.ClaudeEssentials.Hooks.Tools.GrepToolInput', 'CloudNimble.ClaudeEssentials.Hooks.Tools', 'class', 'System.Object']
---
...
```csharp
CloudNimble.ClaudeEssentials.Hooks.Tools.GrepToolInput
```
