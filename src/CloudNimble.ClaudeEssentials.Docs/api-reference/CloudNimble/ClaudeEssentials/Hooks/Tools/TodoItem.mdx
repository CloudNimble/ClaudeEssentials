...
keywords: ['TodoItem', 'CloudNimble.ClaudeEssentials.Hooks.Tools.TodoItem', 'CloudNimble.ClaudeEssentials.Hooks.Tools', 'class', 'System.Object']
---
...
```csharp
CloudNimble.ClaudeEssentials.Hooks.Tools.TodoItem
```
