...
Provides static helper methods for serializing and deserializing Claude Code hook types.
            All methods use the AOT-compatible [ClaudeHooksJsonContext](/api-reference/CloudNimble/ClaudeEssentials/Hooks/ClaudeHooksJsonContext) for serialization.
...
Gets the default [JsonSerializerOptions](https://learn.microsoft.com/dotnet/api/system.text.json.jsonserializeroptions) configured for Claude Code hooks.
            This instance is configured with the [ClaudeHooksJsonContext](/api-reference/CloudNimble/ClaudeEssentials/Hooks/ClaudeHooksJsonContext) for AOT compatibility.
...
Deserializes a JSON string to a [NotificationHookInput](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Inputs/NotificationHookInput).
...
Deserializes a JSON string to a [PreCompactHookInput](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Inputs/PreCompactHookInput).
...
Deserializes a JSON string to a [SessionEndHookInput](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Inputs/SessionEndHookInput).
...
Deserializes a JSON string to a [SessionStartHookInput](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Inputs/SessionStartHookInput).
...
Deserializes a JSON string to a [StopHookInput](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Inputs/StopHookInput).
...
Deserializes a JSON string to a [SubagentStopHookInput](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Inputs/SubagentStopHookInput).
...
Deserializes a JSON string to a [UserPromptSubmitHookInput](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Inputs/UserPromptSubmitHookInput).
...
Serializes a [NotificationHookOutput](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Outputs/NotificationHookOutput) to JSON.
...
Serializes a [PostToolUseHookOutput](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Outputs/PostToolUseHookOutput) to JSON.
...
Serializes a [PreCompactHookOutput](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Outputs/PreCompactHookOutput) to JSON.
...
Serializes a [SessionEndHookOutput](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Outputs/SessionEndHookOutput) to JSON.
...
Serializes a [SessionStartHookOutput](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Outputs/SessionStartHookOutput) to JSON.
...
Serializes a [StopHookOutput](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Outputs/StopHookOutput) to JSON.
...
Serializes a [SubagentStopHookOutput](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Outputs/SubagentStopHookOutput) to JSON.
...
Serializes a [UserPromptSubmitHookOutput](/api-reference/CloudNimble/ClaudeEssentials/Hooks/Outputs/UserPromptSubmitHookOutput) to JSON.
